...
namespace ExamenWeb.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactoID,Nombre,Apellido,DocumentoIdentidad,FechaCreacion")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactoID,Nombre,Apellido,DocumentoIdentidad,FechaCreacion")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
